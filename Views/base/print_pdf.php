...
$pdf->SetX(2);
$pdf->Cell(8,1.5,utf8_decode('Nombre documento'),1,0,'C',true);
$pdf->Cell(13,1.5,utf8_decode('Tipo documento'),1,0,'C',true);
...
while ($row=mysqli_fetch_array($datos))
{
    $pdf->ln();
    $pdf->SetX(2);
    $pdf->Cell(8,0.6,utf8_decode($row [0]),1,0,'C',true);
    $pdf->Cell(13,0.6,utf8_decode($row [1]),1,0,'C',true);
